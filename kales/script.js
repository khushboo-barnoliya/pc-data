...
function cartCounting8(click){
    let inputCount8 = document.getElementById("shopQuantity");
    let sumCount8 = parseInt(inputCount8.innerText) + click;

    inputCount8.innerText = sumCount8;

    if(inputCount8.innerText < 1){
        inputCount8.innerText = 1;
    }
}
